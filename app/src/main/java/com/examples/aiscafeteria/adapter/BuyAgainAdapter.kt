...
import com.examples.aiscafeteria.databinding.BuyAgainItemBinding
...
class BuyAgainAdapter(
    ...
    inner class BuyAgainViewHolder(private val binding: BuyAgainItemBinding) :
        ...
        fun bind(foodName: String, foodPrice: String, foodImage: String) {
            ...
            Log.d("BuyAgainAdapter", "Binding food: ${binding.buyAgainFoodName.text}, price: ${binding.buyAgainFoodPrice.text}, image: ${binding.buyAgainFoodImage}")
